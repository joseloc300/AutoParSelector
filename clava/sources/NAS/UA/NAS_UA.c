...
/* common /bench1/ */
double x0, _y0, z0, time_no_collision;
...
int main(int argc, char *argv[])
{
    ...
    for (step = 0; step <= niter; step++)
    {
        ...
        time_no_collision = time_no_collision + dtime;
...
void adaptation(int *ifmortar, int step)
{
    ...
    *ifmortar = 0;
    ...
    x0 = X00 + VELX * time_no_collision;
    _y0 = Y00 + VELY * time_no_collision;
    z0 = Z00 + VELZ * time_no_collision;
...
void convect(int ifmortar)
{
    ...
    dtime2     = dtime / 2.0;
    rdtime     = 1.0 / dtime;
    subtime[0] = time_no_collision;
    subtime[1] = time_no_collision + dtime2;
    subtime[2] = time_no_collision + dtime;
